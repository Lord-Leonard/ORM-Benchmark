...
export async function prismaBenchmark(entityCount: number, iterations: number, chunkSice: number) {
    ...
    for (let i = 0; i < iterations; i++) {
        ...
        for (let i = 0; (i * chunkSice) < treeDataSet.length; i++) {
            ...
            const sql2 = Prisma.sql`
                INSERT INTO "Tree" ("point", "height", "trunkCircumference", "careState", "strikingForLandscape",
                                    "cropSize",
